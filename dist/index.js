...
class EstudianteUnivo {
    constructor(nombre, apellido, telefono, correo, carnetU) {
        this.nombre = nombre;
...
const estudiante1887 = new EstudianteUnivo("Angel", "Morataya", "7209-3376", "angel.morataya@univo.edu.sv", "U20261887");
...
class Producto {
    ...
    calcularPrecio(descuentoPorcentaje) {
